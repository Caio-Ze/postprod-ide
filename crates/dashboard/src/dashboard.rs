...
pub(crate) use dashboard_panel::open_dashboard_as_tab;
use hotkeys::GlobalShortcutModal;
pub use hotkeys::init_global_hotkeys;
pub(crate) use param_drop::normalize_for_param_type;
...
pub struct DashboardItem {
    ...
    pub(crate) param_values: HashMap<String, HashMap<String, String>>,
