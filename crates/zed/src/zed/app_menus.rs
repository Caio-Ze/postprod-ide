...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    vec![
        Menu {
            name: "ProTools Studio".into(),
            items: vec![
                MenuItem::action("About ProTools Studio", zed_actions::About),
                ...
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide ProTools Studio", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit ProTools Studio", Quit),
            ],
        },
        Menu {
            name: "File".into(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("Show Dashboard", dashboard::ShowDashboard),
                MenuItem::separator(),
                ...
                MenuItem::action(
                    "ProTools Studio Repository",
                    super::OpenBrowser {
                        url: "https://github.com/Caio-Ze/protools-studio".into(),
                    },
                ),
            ],
        },
